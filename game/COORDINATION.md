...
```
### YYYY-MM-DD Ã¢â‚¬â€ STATUS Ã¢â‚¬â€ short title
- Commit: <sha>
- Files: <paths>
...
### 2026-08-29 — DONE — HUD icons (Riven play sign-off)
- Commit: ee86853
- Files: game/game.mjs game/tests/art-upgrade.test.mjs
- Tests: node --test tests/*.test.mjs → 76/76. Riven signed off in a 960×540 play frame at spawn (not a sheet): flask+leaf, 200px bar, three bottles + yellow select, Arko bird, page glyph. F8/walk/P2 untouched.
- Next: Kael idle lock (walk already signed off 8ef11ef). Then boss unique curse color + horns if idle is skipped.
### 2026-08-29 â€” OPEN â€” HUD icons (Riven spec)
- Commit: (this commit)
- Files: game/game.mjs game/tests/art-upgrade.test.mjs
- Tests: node --test tests/*.test.mjs â†’ 76/76
...
### 2026-08-29 Ã¢â‚¬â€ OPEN Ã¢â‚¬â€ P2 playcheck loop
- Commit: (this commit)
- Files: game/COORDINATION.md
- Tests: n/a docs
- Next: Codex implement P2 layout NOW on game-pilot (farmer clamp, brute pack stagger, boss not at 4130). Unit tests green is not enough. After push, write SHA + files + test result in game/CODEX.md. Playcheck is Mira at http://127.0.0.1:8765/ Ã¢â‚¬â€ Orion marks DONE only after that playcheck, never after docs-only commits.

### 2026-08-29 Ã¢â‚¬â€ APPROVED Ã¢â‚¬â€ Riven cycle-1 art locks
- Commit: (this commit)
- Files: game/COORDINATION.md
- Tests: n/a docs
- Next: Codex keep P2 layout-only and honor art constraints (no new tiles/biomes/sprites). Art must-haves after P2.

### 2026-08-29 Ã¢â‚¬â€ APPROVED Ã¢â‚¬â€ Vara cycle-1 locks + P2 spec
- Commit: (this commit)
- Files: game/COORDINATION.md
- Tests: n/a docs
...
### 2026-08-29 Ã¢â‚¬â€ APPROVED Ã¢â‚¬â€ Start P2 layout now
- Commit: (this commit)
- Files: game/COORDINATION.md
- Tests: n/a docs
...
### 2026-08-29 Ã¢â‚¬â€ DONE Ã¢â‚¬â€ Bidirectional channel closed KAEL-PING-CODEX-B
...
### 2026-08-29 Ã¢â‚¬â€ DONE Ã¢â‚¬â€ Comms ping KAEL-PING-20260829-A
- Commit: 3f1ccb2
- Files: game/COORDINATION.md
- Tests: n/a docs
- Next: wait for Vara and Riven. Channel works.

### 2026-08-29 Ã¢â‚¬â€ DONE Ã¢â‚¬â€ P0 win + P1 checkpoint
- Commit: e36dfeb
...
### 2026-08-29 Ã¢â‚¬â€ DONE Ã¢â‚¬â€ Overlay locks
- Commit: c5f9d4e
- Files: game/tests/win-overlay.test.mjs
- Tests: 2/2 green
- Next: GitHub as channel (c1ac995)

### 2026-08-29 Ã¢â‚¬â€ DONE Ã¢â‚¬â€ GitHub channel + board
- Commit: c1ac995
- Files: game/COORDINATION.md
- Tests: n/a docs
- Next: this update-protocol commit (docs only)

### 2026-08-29 Ã¢â‚¬â€ DONE Ã¢â‚¬â€ Automatic follow for Codex
- Commit: 45995d4
- Files: game/COORDINATION.md
- Tests: n/a docs
- Next: Watch + scheduled task (now on)

### 2026-08-29 Ã¢â‚¬â€ DONE Ã¢â‚¬â€ Codex monitor active
