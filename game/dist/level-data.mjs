...
export function updateEnemyActivation(e,playerX,viewLeft,viewWidth){
 ...
 if(e.freed)return e;
 return{...e,active:e.alive&&gate&&(e.active||near||visible),visible:visible&&gate};
}
